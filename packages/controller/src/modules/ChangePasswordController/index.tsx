...
// class ChangePassword extends React.PureComponent<ChildMutateProps<Props, SendForgotPasswordMutation, SendForgotPasswordMutationVariables>> {
...
// >(forgotPasswordMutation)(ChangePassword);
